...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			CASE 
				...
				ELSE 'n/a'
			END cst_marital_status,		-- Normalize marital status value to redable format
			CASE 
	...
	-- Loading silver.crm_prd_info
		...
		SELECT
			...
			CAST(LEAD(prd_start_dt) OVER (PARTITION BY prd_key ORDER BY prd_start_dt)-1 AS DATE) prd_end_dt_tast
